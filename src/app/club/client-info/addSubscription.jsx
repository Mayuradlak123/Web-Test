...
import { addSubscriptionInfoClient } from '@/serverActions';
...
const MeetingModal = ({ isOpen, onClose, }) => {
  ...
  const params = useSearchParams()
    ...
    async function subscribe(data){
        ...
        const res = await addSubscriptionInfoClient(data, refreshToken, id);    
        toast.remove(toastId);
        // console.log(res)
        if(res.status){
          toast.success("Subscription Added Successfully!", {duration:5000});
